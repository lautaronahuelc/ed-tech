// Variables
const verCarrito = document.querySelector('.user-cart');
...
function mostrarCarrito(e){
    if(e.target.classList.contains('user-cart') || e.target.classList.contains('shopping-cart')){
        carrito.classList.toggle('carrito-hidden');
    }
}
